...
Ok let's take a look at some of these fairness measures in action. We are going to train a decision tree on a data set focused on Japanese Loan Approval to see if gender and sex play a role in the approval of the loans. 
...
loan_plot <- rpart.plot(loan_tree$finalModel, type =4, extra = 101)
