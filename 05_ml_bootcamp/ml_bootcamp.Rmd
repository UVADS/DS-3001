...
###Build our own normalizer, which is maybe how I would go if given the option. If you need to do multiple columns use lapply. See this referred to as a minmax scaler function.
...
table(mfr)#we should collapse this factor, it has too many categories G,K and everyone else. 
table(mfr)
...
abc <- names(select_if(cereal, is.numeric))
