...
a question for each dataset that requires at a minimum three "levels" 
...
## Pseudocode 
  ...
  - Calculate % Admitted
  - Arrange in descending order by Ave GPA


Loading and preparing the data 
```{r}
admit_2 <- read_csv("~/git_3001/DS-4001/data/LogReg.csv")
