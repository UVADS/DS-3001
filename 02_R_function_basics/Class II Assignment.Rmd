...
x1 <- group_by(admit_2,rank)# grouping by the factor variables 
...
x2$ave_admit <- x2$admit/x2$count # added a variable ave to the x2,by dividing total admitted by total count for each of the ranking levels

x3 <- arrange(x2,desc(`rank`))# Arrange by rank descending 
print(x3)
## Are there differences in the admitted number of students on average by GPA and school rank?
