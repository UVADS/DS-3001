...
many features. Using the readme and your groups intuition to reduce the number 
of variables down to around 20ish. 

You've done most of the hard work already, so you should be ready to move forward
with building your model. 

Use the question/target variable you submitted from last week and build a model
to answer the question. 

Build and optimize a kNN model to predict your target variable. Meaning use the tune
set to select the correct k value. 

Evaluate the results, talking through your question. What concerns do you have 
about the model? 
...
str(grad_data_3)#Ok looking good, still likely want to drop a few columns, 
# need to normalize and one_hot encode before we move forward with model building.
