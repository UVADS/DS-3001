...
```{r}
bank_data <-  read_csv("/Users/amelianorman/Desktop/DS-3001/data/bank.csv")
...
adjust_thres(final_model$pos_prec,.90,as.factor(final_model$target))
