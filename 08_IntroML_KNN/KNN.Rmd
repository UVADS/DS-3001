...
```{r}
bank_data = read_csv("C:/Users/Maddie/OneDrive/Desktop/3YEAR/Forked-DS-3001/08_IntroML_KNN/bank.csv")

# Check the structure and view the data.
table(bank_data$`signed up`)

#check for missing data (takes out all rows w/ missing values)
...
# k=3, so we have 3 potential outputs -> 1/3, 2/3, or 3/3
