...
table(loan_data$race)#first we can use table to see the frequencies at each of the categories. Given that this is Japanese data we will classify v and Japanese, h as white, bb as black, ff as Hispanic and everything else into other. 
