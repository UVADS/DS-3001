...
## Learning Outcomes 
  ...
  * Understand that the selection of a model evaluation metric is related to your
    question. 
  * Evaluation Metrics can be misleading, meaning using several metrics at any one 
    time is best practices 
